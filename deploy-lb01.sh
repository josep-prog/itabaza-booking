...
# iTABAZA Booking System - LB-01 Deployment Script
# Server: ubuntu@54.235.237.101

echo "🚀 Deploying iTABAZA Booking System to LB-01 (54.235.237.101)..."

# Configuration
SERVER_IP="54.235.237.101"
SERVER_USER="ubuntu"
SSH_KEY="~/.ssh/school"
...
echo "  Environment: Production (LB-01)"
...
echo -e "${GREEN}🎉 Deployment to LB-01 completed successfully!${NC}"
