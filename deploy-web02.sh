...
# iTABAZA Booking System - Web02 Deployment Script
# Server: ubuntu@54.86.41.67

echo "🚀 Deploying iTABAZA Booking System to Web02 (54.86.41.67)..."

# Configuration
SERVER_IP="54.86.41.67"
SERVER_USER="ubuntu"
SSH_KEY="~/.ssh/school"
...
echo "  Environment: Production (Web02)"
...
echo -e "${GREEN}🎉 Deployment to Web02 completed successfully!${NC}"
