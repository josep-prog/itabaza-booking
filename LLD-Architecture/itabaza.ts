// HLD ARCHITECTURE OF iTABAZA HOSPITAL
...
// iTABAZA Hospital Management System - LLD Implementation
// - Departments
// - Doctors
// - Patients
// - Payments
...
const iTABAZA = new iTABAZAHospital();
const createDept = iTABAZA.createNewDepartment(
    "Cardiology",
...
const newDoctor = iTABAZA.addDoctor(
    "Deepak chourasiya",
...
const registerPatient = iTABAZA.registerPatient(
    "John",
    "Doe",
    "john@gmail.com",
    "7844401254",
...
const makePayment = iTABAZA.makePayment(1, 2000, "03-04-2023", "Card");
const giveFeedback = iTABAZA.giveFeedback(
    1,
    "It was great experience with iTABAZA hospital,one thing could be improve response time from the deoctors side",
    "4 PM"
);
